      ...
      <div class="container py-14 py-md-18">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-6 text-center">
          <div class="col-md-6 col-lg-3">
            <img src="<?php echo base_url('template') ?>/assets/img/icons/lineal/browser.svg" class="svg-inject icon-svg icon-svg-md text-violet mb-3" alt="" />
            <h4>Web Design</h4>
          ...
          <!--/column -->
          <div class="col-md-6 col-lg-3">
            <img src="<?php echo base_url('template') ?>/assets/img/icons/lineal/smartphone.svg" class="svg-inject icon-svg icon-svg-md text-blue mb-3" alt="" />
            <h4>Mobile Design</h4>
            <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
          </div>
          <!--/column -->
          <div class="col-md-6 col-lg-3">
            <img src="<?php echo base_url('template') ?>/assets/img/icons/lineal/settings-3.svg" class="svg-inject icon-svg icon-svg-md text-leaf mb-3" alt="" />
            <h4>Development</h4>
            <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
          </div>
          <!--/column -->
          <div class="col-md-6 col-lg-3">
            <img src="<?php echo base_url('template') ?>/assets/img/icons/lineal/search-2.svg" class="svg-inject icon-svg icon-svg-md text-pink mb-3" alt="" />
            <h4>SEO</h4>
            <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
          </div>
          <!--/column -->
          ...
          <div class="card-body p-12 pb-0">
            <div class="row">
              ...
              <div class="col-lg-7 offset-lg-1 align-self-end">
                <figure><img class="img-fluid" src="<?php echo base_url('template') ?>/assets/img/photos/f1.png" srcset="./assets/img/photos/f1@2x.png 2x" alt="" /></figure>
              </div>
              <!-- /column -->
            </div>
            <!-- /.row -->
        ...
        <div class="card bg-soft-blue mb-10">
          <div class="card-body p-12">
            <div class="row gy-10 align-items-center">
              ...
              <!-- /column -->
              <div class="col-lg-7">
                <figure><img class="img-fluid" src="<?php echo base_url('template') ?>/assets/img/photos/f2.png" srcset="./assets/img/photos/f2@2x.png 2x" alt="" /></figure>
              </div>
              <!-- /column -->
            </div>
            <!-- /.row -->
        ...
        <div class="row gx-md-8 gx-xl-10">
          <div class="col-lg-6">
            <div class="card bg-soft-leaf mb-10">
              ...
              <!--/.card-body -->
              <img class="card-img-bottom" src="<?php echo base_url('template') ?>/assets/img/photos/f3.png" srcset="./assets/img/photos/f3@2x.png 2x" alt="" />
            </div>
            <!--/.card -->
          </div>
          <!-- /column -->
          <div class="col-lg-6">
            <div class="card bg-soft-pink">
              ...
              <!--/.card-body -->
              <img class="card-img-bottom" src="<?php echo base_url('template') ?>/assets/img/photos/f4.png" srcset="./assets/img/photos/f4@2x.png 2x" alt="" />
            </div>
            <!--/.card -->
          </div>
          <!-- /column -->
