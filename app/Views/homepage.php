...
<html lang="en">
   ...
   <body>
      ...
      <!-- /.content-wrapper -->
      <footer class="section-red text-inverse">
        <div class="container py-13 py-md-15">
          <div class="row gy-6 gy-lg-0">
            <div class="col-md-12 col-lg-3">
              <div class="widget">
                <img src="<?php echo base_url('template') ?>/assets/img/gsi/LOGO GENOMIC SHRIMP PUTIH.png" srcset="<?php echo base_url('template') ?>/assets/img/gsi/LOGO GENOMIC SHRIMP PUTIH.png 2x" alt="" />
                <p class="mb-5 custom-font-white">Slogan Genomic Shrimp Indonesia</p>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="widget">
                <h4 class="widget-title mb-3 custom-font-white">Menu</h4>
                <ul class="list-unstyled mb-0">
                  <li><a class="scroll custom-font-white" href="#beranda">Beranda</a></li>
                  <li><a class="scroll custom-font-white" href="#product">Produk</a></li>
                  <li><a class="scroll custom-font-white" href="#testimoni">Testimoni</a></li>
                  <li><a class="scroll custom-font-white" href="#tentangKami">Tentang Kami</a></li>
                  <li><a class="scroll custom-font-white" href="#">Privacy Policy</a></li>
                  <li><a class="scroll custom-font-white" href="#">Term & Condition</a></li>
                </ul>
              </div>
              <!-- /.widget -->
            </div>
            ...
            <div class="col-md-4 col-lg-3">
              <div class="widget">
                <h4 class="widget-title custom-font-white mb-3">Penerimaan Sample</h4>
                <p class="pe-xl-15 pe-xxl-17 custom-font-white">Senin - Minggu<br>08.30 - 17.30</p>
              </div>
              <div class="widget">
                <h4 class="widget-title custom-font-white mb-3">Lokasi</h4>
                <address class="pe-xl-15 pe-xxl-17 custom-font-white">Genomics Hub Jl. Sultan Agung No.29, Guntur, Setiabudi, Jakarta Selatan, DKI Jakarta 12980</address>
              </div>
              <div class="widget">
                <h4 class="widget-title custom-font-white mb-3">Get in Touch</h4>
                <a href="mailto:marketing@gsilab.id"><img src="<?php echo base_url('template') ?>/assets/img/gsi/email2.png" class="img fluid w-5" alt="" /> marketing@gsilab.id</a><br>
                <a href="https://wa.me/628111965699" target="_blank"><img src="<?php echo base_url('template') ?>/assets/img/gsi/wa.png" class="img fluid w-5" alt="" /> 0811-1965-699</a>
              </div>
              <!-- /.widget -->
            </div>
            <!-- /column -->
            <div class="col-md-4 col-lg-2 ">
              <div class="widget">
                <h4 class="widget-title mb-4 custom-font-white">Follow for More</h4>
                <nav class="nav social social-white">
                  <a href="https://www.instagram.com/gsilab.id/" target="_blank"><img src="<?php echo base_url('template')?>/assets/img/gsi/instagram.png" class="img fluid w-5" alt="" /></a><br>
                  <a href="https://www.facebook.com/GSILAB.ID/" target="_blank"><img src="<?php echo base_url('template')?>/assets/img/gsi/facebook.png" class="img fluid w-5" alt="" /></a><br>
                  <a href="https://www.tiktok.com/@gsilab.id" target="_blank"><img src="<?php echo base_url('template')?>/assets/img/gsi/tiktok.png" class="img fluid w-5" alt="" /></a><br>
                  <a href="https://www.linkedin.com/company/gsi-lab/mycompany/" target="_blank"><img src="<?php echo base_url('template')?>/assets/img/gsi/linkind.png" class="img fluid w-5" alt="" /></a><br>
                </nav>
                <!-- /.social -->
              </div>
              <!-- /.widget -->
